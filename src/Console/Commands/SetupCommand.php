...
/**
 * Class SetupCommand
 * @package InetStudio\Rating\Console\Commands
 */
class SetupCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'inetstudio:rating:setup';
     ...
     * @var string
     */
    protected $description = 'Setup rating package';
    ...
    private function initCommands(): void
    {
        $this->calls = [
            [
                ...
                'params' => [
                    '--provider' => 'InetStudio\Rating\Providers\RatingServiceProvider',
                    '--tag' => 'migrations',
                ],
            ],
            [
